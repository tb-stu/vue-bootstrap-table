...
var script = {
  ...
  methods: {
    ...
    getCellTitle: function getCellTitle(day) {
      ...
      var title = this.formatDate(date, fmt);
...
var __vue_render__$4 = function __vue_render__() {
  ...
  return _c('table', {
    ...
    return _c('tr', {
      ...
      }, [_c('div', [_vm._v(_vm._s(_vm.showBeYear ? cell + 543 : cell))])]);
    }), 0);
  }), 0);
};
...
var __vue_render__$5 = function __vue_render__() {
  ...
  return _c('div', {
  ...
  }, [_vm.panel === 'year' ? [_c('span', [_vm._v(_vm._s(_vm.showBeYear ? _vm.calendarDecade + 543 : _vm.calendarDecade))]), _vm._v(" "), _c('span', {
    class: _vm.prefixClass + "-calendar-decade-separator"
  }), _vm._v(" "), _c('span', [_vm._v(_vm._s((_vm.showBeYear ? _vm.calendarDecade + 543 : _vm.calendarDecade) + 9))])] : _vm.panel === 'month' ? _c('button', {
  ...
  }, [_vm._v("\n        " + _vm._s(_vm.showBeYear ? _vm.calendarYear + 543 : _vm.calendarYear) + "\n      ")]) : _vm.panel === 'date' ? _vm._l(_vm.dateHeader, function (item) {
    return _c('button', {
      key: item.panel,
    ...
    }, [_vm._v("\n          " + _vm._s(item.panel === 'year' && _vm.showBeYear ? parseInt(item.label) + 543 : item.label) + "\n        ")]);
...
var script$7 = {
  ...
  computed: {
    ...
    title: function title() {
      ...
      var title = this.formatDate(date, titleFormat);
...
var script$8 = {
  ...
  computed: {
    ...
    text: function text() {
      ...
      var text = this.formatDate(this.innerValue, fmt);

      if (this.showBeYear) {
        var dayFormat = fmt.match(/[D]+/);
        var monthFormat = fmt.match(/[M]+/);
        var yearFormat = fmt.match(/[Y]+/);
        var date = new Date(this.innerValue);
        text = fmt.replace(dayFormat, this.formatDate(date, dayFormat)).replace(monthFormat, this.formatDate(date, monthFormat)).replace(yearFormat, this.formatDate(date.setFullYear(this.innerValue.getFullYear() + 543), yearFormat));
